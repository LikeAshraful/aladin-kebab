...
foreach ($config['menu'] as $link => $key) { ?>
                                            <li data-position="1" class="completed <?php
    ...
    ?>" style="padding: 0px 43px;">
                                                <a href="javascript:void(0);"
                                                   <?php if (($si) <= $current_link_index) { ?>  style="background-color: rgb(230, 230, 230);"  <?php } ?>>
                                                    <h1>
                                                        <?php echo $si++ ?>.
                                                    </h1>
                                                    <?php echo $key ?>
                                                    ...
                                                    <?php if (($si - 1) <= $current_link_index) { ?>
                                                        <span
                                                            class="glyphicon glyphicon-ok-sign aiia-wizard-icon-step-completed"
                                                            style="position: absolute; top: -20px; right: -17px; font-size: 4em; color: green;"></span>

...
function create_symlink($targetFolder, $linkFolder)
{

    // Check if the target folder exists
    if (! file_exists($targetFolder)) {
        throw (new Exception("Target folder does not exist: $targetFolder"));
    }

    // Check if symlink already exists
    if (file_exists($linkFolder)) {
        throw (new Exception("Symlink already exists: $linkFolder"));
    }
    ...
    if (symlink($targetFolder, $linkFolder)) {
        ...
        throw (new Exception("Error creating symlink: $linkFolder"));
    }

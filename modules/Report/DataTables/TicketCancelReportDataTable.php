...
class TicketCancelReportDataTable extends DataTable
{
    /**
    ...
    public function query(AirTicket $model): QueryBuilder
    {
        ...
        $query = $model->newQuery()
            ->with(['issued_user', 'pnr.travelers', 'pnr.legs', 'pnr.flights', 'pnr.baggages', 'details'])->cancelled()->orderByDesc('id');
    ...
    {
        return $this->builder()
            ->setTableId('ticket-cancel-report-table')
    ...
    {
        return 'ticket_cancel_report'.date('YmdHis');
    }
}

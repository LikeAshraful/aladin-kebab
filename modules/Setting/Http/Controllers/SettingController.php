...
class SettingController extends Controller
{
    ...
    public function gdsEdit(Request $request)
    {
        $gds = AppSettingGds::first();

        return \view('setting::gds', [
            'gds' => $gds,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', __('Successfully Create Setting'));
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', __('Setting Successfully Saved'));
    ...
    public function destroy(Setting $setting)
    {
        ...
        // forget cache
        SettingFacades::forgetCache();
        Session::flash('success', __('Setting Successfully Deleted'));

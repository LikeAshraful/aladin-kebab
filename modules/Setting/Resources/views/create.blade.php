            ...
            <form action="{{ route(config('theme.rprefix').'.store') }}" method="POST" class="needs-validation"
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <a href="javaScript:void(0);" class="setting-extra-btn my-2 btn btn-outline-success mx-2 d-none active"
                    ...
                    <div class="col-md-12 form-group d-none" id="extraOption" >
                        ...
                        <textarea name="details" id="setting_details_textarea" class="d-none">{{ $details ?? '' }}</textarea>
                        <hr>
                    </div>

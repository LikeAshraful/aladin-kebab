...
Route::prefix('admin/setting')->as('admin.setting.')->middleware(['auth'])->group(function () {
     ...
     * New routes
     */
    Route::get('/destroy-exclude-airline/{id}', [SettingController::class, 'destroyExcludeAirline'])->name('destroy-exclude-airline');
    Route::post('/gds-update', [SettingController::class, 'gdsUpdate'])->name('gds-update');
    ...
    Route::prefix('/mail')->as('mail.')->group(
        function () {
    ...
    Route::prefix('/recaptcha')->as('recaptcha.')->group(
        function () {

                        ...
                        <div class=" row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group pt-1 pb-1">
                                    ...
                                    <input type="number" class="form-control arrow-hidden" name="phone"
                                        id="phone" placeholder="{{ __('Enter phone') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group pt-1 pb-1">
                                    ...
                                    <input type="number" class="form-control arrow-hidden" name="age"
                                        id="age" placeholder="{{ __('Enter your age') }}"
                            ...
                            <div class="col-md-6 py-1">
                                <div class="form-group pt-1 pb-1">
                                    ...
                                    <textarea name="address" id="address" class="form-control n-min-height" placeholder="{{ __('Enter your address') }}">{{ isset($item) ? $item->address : old('address') }}</textarea>
                                    @error('address')
                                        <p class="text-danger pt-2">{{ $message }}</p>
                                    @enderror
                                </div>
    ...
    $item
        ...
        ->first() == $role->id
                                                    ...
                                                    <div class="row py-3">
                                                        ...
                                                        @empty
                                                            <div class="col-md-12 text-center p-5">
                                                                <p class="text-danger">{{ __('No Permission Found') }}
                                                                </p>
                                                            </div>
                                                        @endforelse
                                                    </div>
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group pt-1 pb-1">
                                    <button type="submit"
                                        class="btn btn-success btn-round">{{ __('Save') }}</button>
                                </div>
                            </div>
                        </div>
                    </fieldset>

        ...
        <ul class="navbar-nav flex-row align-items-center">
            ...
            <li class="nav-item dropdown language-menu notification">
                ...
                <div class="dropdown-menu language_dropdown user-header-menu">
                    <h6 class="notification-title">@lang('Language')</h6>
            ...
            <li class="nav-item dropdown notification user-header-menu">
                <a class="nav-link dropdown-toggle " href="#" role="button" data-bs-toggle="dropdown"
                    ...
                    <img class="img-fluid"
                        src="{{ isset(auth()->user()->profile_photo_path) ? URL::to('storage') . '/' . auth()->user()->profile_photo_path : nanopkg_asset('image/blank.png') }}">
                </a>

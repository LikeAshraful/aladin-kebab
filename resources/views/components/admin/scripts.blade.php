...
@stack('js')
<script src="{{ module_asset('js/booking/booking.js') }}"></script>
<script src="{{ module_asset('js/setting/setting.js') }}"></script>
{{-- <script src="{{ module_asset('js/agent/index.js') }}"></script> --}}
